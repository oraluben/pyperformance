...
class VenvForBenchmarks(_venv.VirtualEnvironment):
    ...
    def create(cls, root=None, python=None, *,
        ...
        self = super().create(root, python, env=env, withpip=False, install_cds=install_cds)
    ...
    def __init__(self, root, *, base=None, install_cds=False, inherit_environ=None):
        super().__init__(root, base=base, install_cds=install_cds)
